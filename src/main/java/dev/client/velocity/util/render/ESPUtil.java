...
public class ESPUtil {
    ...
    public static void renderFour() {
        ESPUtil.setColor(new Color(255, 255, 255));
    ...
    public static void setColor(Color c2) {
        GL11.glColor4d((double)((float)c2.getRed() / 255.0f), (double)((float)c2.getGreen() / 255.0f), (double)((float)c2.getBlue() / 255.0f), (double)((float)c2.getAlpha() / 255.0f));
    }

    public static void checkSetupFBO() {
        Framebuffer fbo = Minecraft.getMinecraft().getFramebuffer();
        if (fbo != null && fbo.depthBuffer > -1) {
            ESPUtil.setupFBO(fbo);
            fbo.depthBuffer = -1;
        }
    }
